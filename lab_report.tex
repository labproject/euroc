...
\begin{figure}
 ...
 \includegraphics[width=\textwidth]{./Screens/t1_opt2_april.png}\caption{Task 1.1} \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
 \includegraphics[width=\textwidth]{./Screens/t1_3.png}\caption{Task 1.3}
 \end{subfigure}
 \caption{Ergebnis der Online-Evaluation zu Task 1.1 und 1.3 mit 7 von 8 (bzw 5 von 8) möglichen Punkten} \label{fig:evat3} 
\end{figure}
